...
function renderCatalogue(list) {
  ...
  list.forEach(item => {
    ...
    const webpUrl = `https://lucky-creations.github.io/images/phone-pouches/${enc(base)}.webp`;
    const pngUrl  = `https://lucky-creations.github.io/images/phone-pouches/${enc(file)}`;
...
.catch(err => {
  ...
  console.error('Error loading phone pouches:', err);
});